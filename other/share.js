...
(document.getElementsByTagName("body"))[0].innerHTML = '<div id="b1"></div><br><div id=b2></div><div id="b3"></div><div id="b4"></div><footer><div>Version 0.2</div><style>footer{position: absolute;bottom: 0;}</style></footer>';
function setDefault() {
