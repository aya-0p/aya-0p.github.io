...
function ulData(e) {
    ...
    if (datas[0] != "backupDatasForZonestcn") {
        ...
        var datas2 = datas.splice(1, datas[1].length - 1);
        var wns = ["we start"]
