...
function setBu() {
    ...
    document.getElementById("b2").innerHTML = null;
    document.getElementById("b3").innerHTML = '<form action="#" onsubmit="return dlData()"><label>バックアップを<input id="file" type="file" name="file"></label></form><br>';
