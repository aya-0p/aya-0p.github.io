...
function ulData(e) {
    ...
    if (isValidJson(e) == true) {
        ...
        if (datas[0] != "backupDatasForZonestcn") {
            ...
            localStorage.setItem("document_list",wns)
