...
function ulData(e) {
    ...
    if (datas[0] != "backupDatasForZonestcn") {
        ...
        var datas2 = datas.splice(1, dList.length - 1);
        var wns = ["we start"]
        datas.forEach(function(value, index) {
            console.log(datas[index][0]);
            console.log(datas[index][1]);
            wns.push(datas[index][0]);
        });
        console.log(wns);
    }
    setDefault();
