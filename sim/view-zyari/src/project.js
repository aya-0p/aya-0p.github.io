window.__require = function e(t, n, a) {
        ...
        cc.Class({
            ...
            savedata: function() {
                ...
                if (JSON.parse(cc.sys.localStorage.getItem(e + "data")))
                    ...
                    JSON.parse(cc.sys.localStorage.getItem("document_zyari")))
                        (t = JSON.parse(cc.sys.localStorage.getItem("document_zyari"))).push(e),
                        cc.sys.localStorage.setItem("document_zyari", JSON.stringify(t));
                    else
                        (t = []).push("we start"),
                        t.push(e),
                        cc.sys.localStorage.setItem("document_zyari", JSON.stringify(t));
                    var u = JSON.parse(cc.sys.localStorage.getItem("document_zyari"));
                    console.log(u),
                    this.node.active = !1
                }
            }
    ...
    save_view_on: [function(e, t, n) {
        ...
        cc.Class({
            ...
            onLoad: function() {
                ...
                JSON.parse(cc.sys.localStorage.getItem("document_zyari"))) {
                    var e = JSON.parse(cc.sys.localStorage.getItem("document_zyari"));
                    a.val = 0;
    ...
    "ui_open-02": [function(e, t, n) {
        ...
        cc.Class({
            ...
            on_touch_end: function(e) {
                if (JSON.parse(cc.sys.localStorage.getItem("document_zyari"))) {
                    this.target.active = !0;
                    var t = JSON.parse(cc.sys.localStorage.getItem("document_zyari"));
                    o.val = 0;
        ...
        cc.Class({
            ...
            enter: function(e) {
                ...
                if (JSON.parse(cc.sys.localStorage.getItem(t)))
                    ...
                    this.node.active = !1;
                    var n = JSON.parse(cc.sys.localStorage.getItem("document_zyari"))
                      , a = n[c.val];
                    if (n.splice(c.val, 1, t),
                    cc.sys.localStorage.setItem("document_zyari", JSON.stringify(n)),
                    o.data(a, t),
